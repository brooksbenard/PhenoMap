...
|----------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[Score Single-cell data](https://brooksbenard.github.io/PhenoMapR/articles/single-cell.md)**                             | Score PAAD single cells (CRA001160) with **TCGA** and **PRECOG** Pancreatic references; scatterplot and boxplots by cell type; prognostic markers and proportion by sample. Data: expression H5 + CellMetainfo from Drive.                |
...
| **[Score bulk expression samples](https://brooksbenard.github.io/PhenoMapR/articles/bulk-survival.md)**                    | Score 289 primary/metastatic bulk samples with PhenoMapR PRECOG references; stratify by primary vs metastatic; **Kaplan–Meier** survival by prognostic score. Data from Drive.                                                            |
