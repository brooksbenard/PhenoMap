...
```
    ...
    ## [Marker analysis GSE111672] Runtime: 0.95 s | Memory: -
...
```
    ...
    ## [Heatmap GSE111672] Runtime: 1.91 s | Memory: -
...
```
    ...
    ## [Proportion plot GSE111672] Runtime: 2.83 s | Memory: -
...
```
    ...
    ## [Marker analysis CRA001160] Runtime: 2.33 s | Memory: -
...
![](gse111672-single-cell_files/figure-html/heatmap-markers-cra001160-1.png)
    ...
    ## [Heatmap CRA001160] Runtime: 6.24 s | Memory: -
