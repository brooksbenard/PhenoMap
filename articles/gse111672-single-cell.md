...
```
    ...
    ## [Heatmap GSE111672] Runtime: 2.04 s | Memory: -
...
```
    ...
    ## [Proportion plot GSE111672] Runtime: 3.02 s | Memory: -
...
```
    ...
    ## [Score CRA001160] Runtime: 0.67 s | Memory: 349.2 Mb
...
```
    ...
    ## [Marker analysis CRA001160] Runtime: 2.24 s | Memory: -
...
![](gse111672-single-cell_files/figure-html/heatmap-markers-cra001160-1.png)
    ...
    ## [Heatmap CRA001160] Runtime: 6.64 s | Memory: -
